...
/**
 * @extends ServiceEntityRepository<Financer>
 *
...
class FinancerRepository extends ServiceEntityRepository
{
    ...
    public function save(Financer $entity, bool $flush = false): void
    {
    ...
    public function remove(Financer $entity, bool $flush = false): void
    {
